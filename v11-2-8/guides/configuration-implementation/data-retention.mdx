...
*Defines policies for storing and managing log data in UTMStack, ensuring compliance with security regulations and optimizing storage efficiency*

![Image](/assets/0aac5f30-16ca-4a87-8608-f85f80aed4dc)
...
> ***Note:**** ****Note****: The system automatically takes action when the disk usage reaches*  
...
> :warning:*** Warning:**** Leaving the port open exposes your OpenSearch data to potential risks. Ensure*  
...
1. **Installation & Access**:
    - Use the <u>[official Cerebro installation guide](https://github.com/lmenezes/cerebro)</u>.
  - Once installed, access its interface, typically found at <u>[http://localhost:9000](http://localhost:9000)</u>.
2. **Restoration Process**:
    > *Link Cerebro with your opensearch node for seamless data restoration*
  > ![Image](/assets/5532742d-8ba5-43cc-b9d6-1adc7a49272f)
