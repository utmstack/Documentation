...
> [!INFO]
> See [System Requirements](/v11/guides/installation/system-requirements) for detailed specifications based on your deployment size and expected data volume.
---
## Installation Flow
