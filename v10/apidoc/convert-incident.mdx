---
title: Convert to Incident API
sidebarTitle: "Convert to Incident"
description: "Convert one or more alerts into a formal security incident for comprehensive case management and investigation tracking."
---
...
- **incidentSource** `string` (required)
