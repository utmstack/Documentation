---
title: Property Values with Count API
sidebarTitle: "Property Values & Count"
description: "Get unique values for alert properties along with their occurrence counts for analytics and filtering purposes."
---
...
- **orderByCount** `boolean` (default: true)
