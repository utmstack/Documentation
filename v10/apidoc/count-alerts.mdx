---
title: Count Open Alerts API
sidebarTitle: "Count Open Alerts"
description: "Get the total count of open alerts in the system for dashboard displays and monitoring purposes."
---
