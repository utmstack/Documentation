...
sidebarTitle: Index Patterns Management
description: "This interface simplifies the process of managing which indices are analyzed and visualized in the system."
---
