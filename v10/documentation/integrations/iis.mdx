---
title: Integration guide for Internet Information Services
sidebarTitle: "Internet Information Services"
description: "Internet Information Services (IIS) is a flexible, general-purpose web server from Microsoft that runs on Windows systems to serve requested HTML pages or files. An IIS web server accepts requests from remote client computers and returns the appropirate response."
---
