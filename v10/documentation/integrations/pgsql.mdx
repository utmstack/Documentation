---
title: Integration guide for PostgreSQL
sidebarTitle: "PostgreSQL"
description: "PostgreSQL is used as the primary data store or data warehouse for many web, mobile, geospatial, and analytics applications."
---
