---
title: Integration guide for MongoDB
...
```
cd /opt/utmstack-linux-agent/beats/filebeat/ && ./filebeat modules enable mongodb
```

> Windows

```
cd "C:\Program Files\UTMStack\UTMStack Agent\beats\filebeat\" && filebeat modules enable mongodb
```
...
```
/opt/utmstack-linux-agent/beats/filebeat/modules.d/mongodb.yml
```

> Windows

```
C:\Program Files\UTMStack\UTMStack Agent\beats\filebeat\modules.d\mongodb.yml
```

<img
  height="200"
  className="block rounded-xl"
  src="/images/integrations/mongodb/config-mongodb.png"
  alt="Mongodb"
/>
