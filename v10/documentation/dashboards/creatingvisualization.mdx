...
<img
  ...
  src="/assets/images/dashboards/newvisualization.png"
  alt="Dashobard"
/>
...
### 2. The New Visualization window requires two primary parameters to create a visualization:
   ...
   2. **Chart Type**:
        <Note>        
            UTMStack supports various chart types, each catering to different data representation requirements:
        </Note>
...
<img
  height="200"
  className="block rounded-xl"
  src="/assets/images/dashboards/visualizationeditor.png"
  alt="Dashobard"
/>
...
<img
  height="200"
  className="block rounded-xl"
  src="/assets/images/dashboards/filervisualizationcreation.png"
  alt="Dashobard"
/>
...
<img
  height="200"
  className="block rounded-xl"
  src="/assets/images/dashboards/filterlist.png"
  alt="Dashobard"
/>
...
<img
  height="200"
  className="block rounded-xl"
  src="/assets/images/dashboards/menu.png"
  alt="Dashobard"
/>
...
<img
  height="200"
  className="block rounded-xl"
  src="/assets/images/dashboards/datasections.png"
  alt="Dashobard"
/>
