...
sidebarTitle: "Creating a Dashboard"
description: "The UTMStack Dashboard provides a flexible and intuitive interface for visualizing and analyzing your data. The process of creating a new dashboard involves selecting and configuring visualizations based on your specific needs."
---
...
<img
  ...
  src="/images/dashboards/newdashboard.png"
  alt="Dashobard"
/>
...
<img
  height="200"
  className="block rounded-xl"
  src="/images/dashboards/dashboardeditorview.png"
  alt="Dashobard"
/>
...
> **Note:** **Resize and Reposition Visualizations**
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/images/dashboards/myfilter.png"
  alt="Dashobard"
/>
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/images/dashboards/savedashwithmyfilter.png"
  alt="Dashobard"
/>
...
> **💡 Tip:** After adjusting these settings to your satisfaction, click "Save" to store your dashboard. Your custom dashboard is now ready for use and can be accessed anytime you need it.
