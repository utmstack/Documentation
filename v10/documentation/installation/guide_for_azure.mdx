...
<img
  ...
  src="/assets/images/guide for azure/vmconf.png"
...
<Warning>
Please refer to the [System Requirements](../Installation/system_requirements) page to select the better option.
</Warning>
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/assets/images/guide for azure/vmconf2.png"
  alt="Master Only Deployment: Unparalleled Data Control and Security"
/>
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/assets/images/guide for azure/vmconf3.png"
  alt="Master Only Deployment: Unparalleled Data Control and Security"
/>
