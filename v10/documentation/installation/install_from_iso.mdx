...
<Note>
For detailed information on the prerequisites,  Please refer to the [System Requirements](../Installation/system_requirements) section before proceeding with the steps outlined in this guide.
</Note>
...
<img
  ...
  src="/assets/images/install from iso/step1.png"
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/assets/images/install from iso/step2.png"
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/assets/images/install from iso/step3.png"
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/assets/images/install from iso/step5.png"
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/assets/images/install from iso/step8.png"
  alt="Certificate"
/>
...
<img
  ...
  noZoom
  className="block rounded-xl"
  src="/assets/images/install from iso/step10.png"
  alt="Login Page"
/>
