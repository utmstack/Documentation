...
<Tip>   
    Follow the provided guide: [Generate SSL with Certbot](../Installation/ssl_certificate).
</Tip>
...
<Tip>
 Refer to the [Email Configuration Section](../configuration/application_settings) for a detailed walkthrough.
</Tip>
