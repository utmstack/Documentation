...
<CardGroup cols={2}>
  <Card title="Log Management & Correlation" icon="pi pi-database" iconAlign="left" content="Advanced real-time log analysis and correlation engine" />
  <Card title="Threat Detection & Response" icon="pi pi-shield" iconAlign="left" content="Identify and respond to threats in real-time" />
  <Card title="Threat Intelligence" icon="pi pi-chart-line" iconAlign="left" content="Integrated threat intelligence feeds and analysis" />
  <Card title="Alert Investigation" icon="pi pi-search" iconAlign="left" content="Comprehensive alert investigation and forensics" />
  <Card title="File Classification" icon="pi pi-file" iconAlign="left" content="Automated file analysis and classification" />
  <Card title="SOC AI-Powered Analysis" icon="pi pi-sitemap" iconAlign="left" content="Machine learning-driven security analysis" />
  <Card title="Security Compliance" icon="pi pi-clipboard" iconAlign="left" content="Built-in compliance management and reporting" />
  <Card title="SOAR Workflows" icon="pi pi-sitemap" iconAlign="left" content="Automated security orchestration and response" />
---
