...
### Step 2: Select Your Data Source
  ...
  ### Click the Pipeline Button
    ...
    Click the pipeline button (📋) next to your data source to open the pipeline editor.
...
<Accordion multiple={true}>
    <AccordionTab header="Use ECS Field Names">
    ...
    **Process Fields**:
    ...
    <AccordionTab header="Handle Parsing Errors Gracefully">
    ...
    <AccordionTab header="Test with Real Logs">
    ...
    <AccordionTab header="Use Conditions for Complex Logic">
    ...
    <AccordionTab header="Add Source Identification">
    ...
    <AccordionTab header="Preserve Original Message">
...
<Accordion multiple={true}>
    <AccordionTab header="Filter shows FAIL status">
    ...
    **Solution**:
    ...
    <AccordionTab header="No events being processed">
    ...
    **Solution**:
    ...
    <AccordionTab header="Fields not extracted correctly">
    ...
    **Solution**:
    ...
    <AccordionTab header="Performance issues / slow processing">
    ...
    **Solution**:
    ...
    <AccordionTab header="Timestamps incorrect or missing">
...
<CardGroup cols={2}>
  <Card title="Implementing Filters" icon="pi pi-filter" iconAlign="left" href="/v11/rules-and-filters/implementing-filters" content="Complete guide to filter syntax and step types" />

  <Card title="Implementing Rules" icon="pi pi-gavel" iconAlign="left" href="/v11/rules-and-filters/implementing-rules" content="Create correlation rules to detect threats" />
