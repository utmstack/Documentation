...
<CardGroup cols={2}>
  <Card title="Small Deployment" icon="pi pi-building" iconAlign="left" content="**50 data sources (120 GB/month)**     - CPU: 4 Cores     - RAM: 16 GB     - Disk: 150 GB SSD     - Ideal for: Small businesses, branch offices" />

  <Card title="Medium Deployment" icon="pi pi-city" iconAlign="left" content="**120 data sources (250 GB/month)**     - CPU: 8 Cores     - RAM: 16 GB     - Disk: 250 GB SSD     - Ideal for: Mid-size organizations" />

  <Card title="Large Deployment" icon="pi pi-building-columns" iconAlign="left" content="**240 data sources (500 GB/month)**     - CPU: 16 Cores     - RAM: 32 GB     - Disk: 500 GB SSD     - Ideal for: Enterprises, MSPs" />

  <Card title="Enterprise Deployment" icon="pi pi-globe" iconAlign="left" content="**500 data sources (1 TB/month)**     - CPU: 32 Cores     - RAM: 64 GB     - Disk: 1 TB SSD     - Ideal for: Large enterprises" />
<Warning>
...
<Accordion multiple={true}>
    <AccordionTab header="22/TCP - SSH (Secure Shell)">
    ...
    **Security Recommendation**: 
    ...
    <AccordionTab header="80/TCP - HTTP Redirect">
    ...
    **Security Recommendation**: 
    ...
    <AccordionTab header="443/TCP - HTTPS">
    ...
    **Security Recommendation**: 
    ...
    <AccordionTab header="9090/TCP - Cockpit">
...
<CardGroup cols={2}>
  <Card title="Architecture" icon="pi pi-sitemap" iconAlign="left" href="/v11/Installation/architecture" content="Learn about UTMStack v11 architecture and deployment models" />
  
  <Card title="Installation Guide" icon="pi pi-download" iconAlign="left" href="/v11/Installation/installation" content="Follow the step-by-step installation instructions" />
