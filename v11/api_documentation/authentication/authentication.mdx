...
<Card title="POST /api/authenticate" icon="pi pi-lock">
...
<ParamField path="rememberMe" type="boolean">
...
<Labels>
  <Label label="Label" color="#3b82f6" size="md" icon="pi pi-bolt" />
  <Label label="Label 2" color="#ef4444" size="md" />
</Labels>
...
<Accordion multiple={true}>
  <AccordionTab title="401 Unauthorized" >
  ...
  <AccordionTab title="403 Forbidden" >
  ...
  <AccordionTab title="500 Internal Server Error" >
