...
<Columns columnCount={2}>
  <Column>
    <Card title="Authentication" icon="pi pi-lock" href="/v10/apidoc/authentication">
    
    Obtain  JWT tokens for API access
    
    </Card>
    <Card title="Update Status" icon="pi pi-refresh" href="/v10/apidoc/update-status">
    
    Change alert status (Open, In Review, Completed)
    
    </Card>
    <Card title="Update Notes" icon="fa fa-sticky-note" href="/v10/apidoc/update-notes">
    
    Add investigation notes to alerts
    
    </Card>
    <Card title="Count Alerts" icon="pi pi-calculator" href="/v10/apidoc/count-alerts">
    
    Get count of open alerts for dashboards
    
    </Card>
    <Card title="CSV Export" icon="pi pi-download" href="/v10/apidoc/csv-export">
...
<RightPanel>
  ...
  ```javascript Esto es un tab largo para probar
