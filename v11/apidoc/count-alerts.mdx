...
<Card title="GET /api/utm-alerts/count-open-alerts" icon="pi pi-calculator" iconAlign="left" content="**Method:** GET     **Authentication:** Bearer Token required     **Response:** Integer count of open alerts" />
...
- **200** (OK): Successfully retrieved the count of open alerts

- **401** (Unauthorized): Missing or invalid Bearer token

- **500** (Internal Server Error): Internal server error while retrieving count
...
<Accordion multiple={true}>
    <AccordionTab header="Polling Frequency">
    ...
    **Recommended intervals:**
    ...
    <AccordionTab header="Error Handling">
    ...
    **Handle failures gracefully:**
    ...
    <AccordionTab header="Alerting Thresholds">
