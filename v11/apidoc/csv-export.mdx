...
<Card title="POST /api/elasticsearch/alerts/export/csv" icon="pi pi-download" iconAlign="left" content="**Method:** POST     **Content-Type:** application/json     **Authentication:** Bearer Token required     **Response:** CSV file download or CSV data" />
...
<Accordion multiple={true}>
    <AccordionTab header="Core Alert Fields">
    ...
    **Essential fields for most exports:**
    ...
    <AccordionTab header="Network Fields">
    ...
    **Network-related alert fields:**
    ...
    <AccordionTab header="Security Fields">
    ...
    **Security-focused fields:**
    ...
    <AccordionTab header="Management Fields">
