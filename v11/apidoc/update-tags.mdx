...
<Card title="POST /api/utm-alerts/tags" icon="pi pi-tags" iconAlign="left" content="**Method:** POST     **Content-Type:** application/json     **Authentication:** Bearer Token required     **Response:** HTTP 200 OK (no body)" />
...
<Accordion multiple={true}>
    <AccordionTab header="Investigation Tags">
    ...
    <AccordionTab header="Classification Tags">
    ...
    <AccordionTab header="Priority Tags">
    ...
    <AccordionTab header="Workflow Tags">
...
<Accordion multiple={true}>
    <AccordionTab header="Tag Naming Conventions">
    ...
    <AccordionTab header="Rule Creation Strategy">
    ...
    <AccordionTab header="Tag Management">
