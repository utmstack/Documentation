...
<Card title="POST /api/utm-alerts/status" icon="pi pi-refresh" iconAlign="left" content="**Method:** POST     **Content-Type:** application/json     **Authentication:** Bearer Token required     **Response:** HTTP 200 OK (no body)" />
...
<CardGroup cols={3}>
  <Card title="OPEN" icon="pi pi-circle-exclamation" iconAlign="left" content="**Value:** 2       Alert is open and pending review" />
  
  <Card title="IN_REVIEW" icon="pi pi-eye" iconAlign="left" content="**Value:** 3       Alert is currently being reviewed" />
  
  <Card title="COMPLETED" icon="pi pi-circle-check" iconAlign="left" content="**Value:** 5       Alert has been resolved/completed" />
---
...
<Accordion multiple={true}>
    <AccordionTab header="Status Workflow">
    ...
    <AccordionTab header="Observation Notes">
