...
<Card title="POST /api/utm-alerts/convert-to-incident" icon="pi pi-arrow-right-arrow-left" iconAlign="left" content="**Method:** POST     **Content-Type:** application/json     **Authentication:** Bearer Token required     **Response:** Incident creation confirmation" />
...
<Accordion multiple={true}>
    <AccordionTab header="Single Complex Alert">
    ...
    **Convert when:**
    ...
    <AccordionTab header="Multiple Related Alerts">
    ...
    **Convert when:**
    ...
    <AccordionTab header="Escalation Scenarios">
...
<Accordion multiple={true}>
    <AccordionTab header="Incident Naming">
    ...
    **Use descriptive names:**
    ...
    <AccordionTab header="Incident ID Management">
    ...
    **ID assignment strategy:**
    ...
    <AccordionTab header="Source Documentation">
