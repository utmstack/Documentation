...
<Card title="POST /api/utm-alerts/notes" icon="pi pi-note-sticky" iconAlign="left" content="**Method:** POST     **Content-Type:** application/json     **Authentication:** Bearer Token required     **Query Parameter:** alertId (required)" />
