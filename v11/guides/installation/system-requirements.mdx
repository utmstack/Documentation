...
> [!WARNING]
> **Horizontal Scaling Required**: Deployments exceeding 500 data sources require adding secondary worker nodes for horizontal scaling. See the [Architecture](/v11/guides/installation/installation) guide for multi-node deployment patterns.
