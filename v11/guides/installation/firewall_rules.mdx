...
<Columns columnCount={2}>
  <Column>
    <Card title="SSL Certificate Setup" icon="hi-lockClosed-solid" href="/v11/Installation/ssl_certificate">
  ...
  <Column>
    <Card title="Agent Installation" icon="fa fa-laptop" href="/v11/integrations">
