...
<Accordion multiple={true}>
  <AccordionTab title="Certificate not recognized by browser" icon="hi-window-solid">
  ...
  <AccordionTab title="Certbot fails with 'Port 80 already in use'" icon="fa fa-plug">
  ...
  <AccordionTab title="Certificate shows as expired" icon="hi-exclamationTriangle-solid">
  ...
  <AccordionTab title="Services won't restart after certificate update" icon="mi-sync">
...
<Columns columnCount={2}>
  <Column>
    <Card title="Use Strong Keys" icon="pi pi-key">
    ...
    <Card title="Monitor Expiration" icon="pi pi-clock">
  ...
  <Column>
    <Card title="Protect Private Keys" icon="pi pi-lock">
    ...
    <Card title="Use Automation" icon="mi-smart_toy">
