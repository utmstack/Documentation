...
<Columns columnCount={2}>
  <Column>
    <Card title="EventProcessor Core" icon="mi-engineering">
    
    Core engine that processes security events, loads plugins, and manages data flow
    
    </Card>
    <Card title="UTMStack Plugins" icon="mi-hub">
  ...
  <Column>
    <Card title="EventProcessor Plugins" icon="hi-puzzlePiece-solid">
    
    Built-in plugins for input, parsing, and analysis tasks in the Event Processor
...
<Accordion multiple={true}>
  <AccordionTab title="What are Rules?" icon="hi-shieldCheck-solid">
...
<Accordion multiple={true}>
  <AccordionTab title="What are Filters?" icon="fa fa-filter">
...
<Columns columnCount={2}>
  <Column>
    <Card title="Modular Design" icon="fa fa-object-ungroup">
    
    Each plugin serves a specific purpose in the processing pipeline
    
    </Card>
    <Card title="gRPC Communication" icon="pi pi-comments">
  ...
  <Column>
    <Card title="Independent Processes" icon="pi pi-server">
    
    Plugins run as separate processes, improving stability
    
    </Card>
    <Card title="Hot Swappable" icon="pi pi-sync">
...
<Columns columnCount={2}>
  <Column>
    <Card title="CPU Usage" icon="pi pi-microchip">
    
    Complex rules and filters consume more CPU. Monitor CPU usage per plugin. Optimize expressions and patterns.
    
    </Card>
  </Column>
  <Column>
    <Card title="Memory Usage" icon="pi pi-memory">
    
    Large event volumes require more memory. Set appropriate buffer sizes. Clean up unnecessary data early.
...
<Columns columnCount={2}>
  <Column>
    <Card title="Implementing Rules" icon="pi pi-shield" href="/v11/rules-and-filters/implementing-rules">
    
    Learn how to create correlation rules to detect security threats
    
    </Card>
    <Card title="Custom Plugins" icon="fa fa-plug" href="/v11/rules-and-filters/custom-plugins">
  ...
  <Column>
    ...
    <Card title="Best Practices" icon="pi pi-star" href="/v11/rules-and-filters/best-practices">
