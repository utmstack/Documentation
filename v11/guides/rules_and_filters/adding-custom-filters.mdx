...
> [!NOTE]
> Custom filters follow the same YAML-based format as standard filters. Review the [Implementing Filters](/v11/guides/rules_and_filters/implementing_filters) guide for syntax details.
---
## Prerequisites
