...
> [!NOTE]
> Custom filters follow the same YAML-based format as standard filters. Review the [Implementing Filters](/v11/guides/rules-and-filters/implementing-filters) guide for syntax details.
---
## Prerequisites
