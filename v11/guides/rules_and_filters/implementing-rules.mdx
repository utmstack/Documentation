...
<Accordion multiple={true}>
  <AccordionTab title="id" icon="hi-fingerPrint-solid">
  ...
  <AccordionTab title="dataTypes" icon="pi pi-database">
  ...
  <AccordionTab title="name" icon="fa fa-tag">
  ...
  <AccordionTab title="description" icon="fa fa-file-powerpoint-o">
...
<Accordion multiple={true}>
  <AccordionTab title="impact" icon="fa fa-bomb">
  ...
  <AccordionTab title="category" icon="mi-workspaces">
  ...
  <AccordionTab title="technique" icon="hi-wrenchScrewdriver-solid">
  ...
  <AccordionTab title="adversary" icon="fa fa-user-secret">
  ...
  <AccordionTab title="references" icon="hi-link-solid">
...
---
## Conditional Logic: The <u>*where*</u> Field
...
```
---
## Event Correlation: The <u>*afterEvents*</u> Field
...
<Columns columnCount={2}>
  <Column>
    <Card title="filter_term" icon="pi pi-equals">
    
    **Exact match** using term search (keyword fields). Best for: IPs, usernames, exact strings.
    
    </Card>
    <Card title="must_not_term" icon="pi pi-ban">
    
    **Not equal** using term search. Best for: Excluding specific values.
    
    </Card>
  </Column>
  <Column>
    <Card title="filter_match" icon="fa fa-search">
    
    **Full-text match** using text search. Best for: Messages, descriptions, analyzed text.
    
    </Card>
    <Card title="must_not_match" icon="hi-xCircle-solid">
    
    **Not matching** using text search. Best for: Excluding text patterns.
...
<Accordion multiple={true}>
  <AccordionTab title="Rule Not Triggering" icon="hi-questionMarkCircle-outline">
  ...
  <AccordionTab title="Too Many False Positives" icon="pi pi-exclamation-triangle">
  ...
  <AccordionTab title="Performance Issues" icon="fa fa-dashboard">
  ...
  <AccordionTab title="Missing Field Errors" icon="hi-plusCircle-solid">
