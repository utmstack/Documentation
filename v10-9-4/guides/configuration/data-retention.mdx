...
<img
  ...
  src="/assets/a9c74830-6b8f-52e1-9581-0e4d6b329b2e"
...
> **⚠️ Warning:** Leaving the port open exposes your OpenSearch data to potential risks. Ensure
...
2. **Restoration Process**:
   ...
   > Link Cerebro with your opensearch node for seamless data restoration
     ...
     <img
       height="200"
       className="block rounded-xl"
       src="/assets/c888f2c0-e4e1-5898-99de-97ef13f6771e"
       alt="Data Sources Overview"
     />
   ...
   <img
     height="200"
     className="block rounded-xl"
     src="/assets/b02d7f27-5184-5289-8309-754eea7c6ec4"
     alt="Data Sources Overview"
   />
