...
<img
  ...
  src="/assets/a46fecfd-e0b1-5313-a405-63ce7c8045c5"
...
> **💡 Tip:** **Security Tip**: To maintain the security integrity of your Connection Key, it’s vital to change it regularly and immediately if there is any suspicion of compromise. Avoid sharing the key with untrusted parties.
...
> **⚠️ Warning:** Always ensure that the new key is distributed securely and updated in all configurations to prevent service disruption.


> **⚠️ Warning:** Keep a secure backup of your Connection Key in a safe location.
